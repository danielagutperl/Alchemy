...
with app.app_context():
    ...
    rose_lemon_spritzer = Drink(
        ...
        image='image-url',
        ingredients='2 tablespoons rose water * optional, 2 tablespoons fresh lemon juice, 1/2-2 ounces vodka omit to make a mocktail!, 1-2 tablespoon honey or to taste (use agave if vegan), a few drops of blood orange or pomegranate juice for color (optional), 3/4 cup sparkling water or more to taste, fresh roses for garnish (optional)',
...
db.session.add_all([pisco_sour, tea_n_tea, rose_lemon_spritzer, bloody_mary, cranberry_mojito, cherry_bomb_mocktail, virgin_strawberry_margarita, pine_lime_mocktail, frozen_banana_colada, blackberry_moscow_mule])
